...
# IR (SPI-SS header)
set_property -dict { PACKAGE_PIN C1   IOSTANDARD LVCMOS33 } [get_ports { ir_in }];

# PMOD JA (I2S2)
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { i2s_mclk }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { i2s_ws }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { i2s_sck }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { i2s_sdata }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { vga_hs }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { vga_vs }]; #IO_L22N_T3_A04_D20_14 Sch=jc_n[3]
